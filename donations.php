		...
		<div style="" class="col-md-8">
			<div class="card">
				<div class="content">
					...
					<p>Hello, Steemauto users. As you know, Steemauto is a free service for all steem users and we don't have any earnings from Steemauto. But, we need to pay for our servers. I know, that is not your business. Just if you can, help us to keep this service free forever.</p>
					<h5>Our bills:</h5>
					<p>1- 256 GB RAM (hetzner): $200/month</p>
					<p>2- 15 GB RAM (scaleway): $40~$50/month</p>
					<p>3- cloudflare: $10/month</p>
					<p>4- Mastercard/Visa: ~$20/month</p>
					<hr>
					<p>Total bill: $270~$300/month</p>
					...
					<a class="btn btn-primary" href="https://steemconnect.com/sign/transfer?to=steemauto&amount=10%20SBD">20 SBD</a>
					<a class="btn btn-primary" href="https://steemconnect.com/sign/transfer?to=steemauto&amount=10%20SBD">50 SBD</a>
					<br><br>
					...
					<a class="btn btn-primary" href="https://steemconnect.com/sign/transfer?to=steemauto&amount=10%20STEEM">20 STEEM</a>
					<a class="btn btn-primary" href="https://steemconnect.com/sign/transfer?to=steemauto&amount=10%20STEEM">50 STEEM</a>
				</div>
			</div>
		</div>
		<div class="col-md-2"></div>
