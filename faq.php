	...
	<div class="content" style="padding-left:30px; padding-right:30px;">
		<div class="card">
			<div class="content faq" style="padding-left:30px; padding-right:30px;">
				...
				<h3>What is Optional benefiaciary in the schedule post?</h3>
				<p>When you set @steemauto as a benefiaciary in your post, steem blockchain will send certain percent of your post reward to the @steemauto. This is optional and you can select between None (0%) and 25%.</p>
				...
				<p><a href="https://steemit.com/steemit/@energyaddict22/steemit-essentials-steemauto" target="_blank">Steemit Essentials - Steemauto</a> by @energyaddict22</p>
